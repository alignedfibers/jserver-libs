  ...
  #Test still run and pass using gradle, but I still thing the mvn build is cleaner.
  ./gradlew clean build
  ...
  #The .java files have had all depracations and errors that made this project not compatible with jdk 11 corrected.
