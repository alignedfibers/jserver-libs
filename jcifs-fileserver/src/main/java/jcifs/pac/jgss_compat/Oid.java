...
/* DerOid not to confuse with ASN1OID */
import java.io.InputStream;
import java.io.IOException;

import jcifs.pac.sun_compat.security.util.DerValue;
...
public class Oid {
    ...
    /**
     * Only for calling by initializers used with declarations.
     *
     * @param strOid
     */
    ...
    public boolean equals(Object other) {
        ...
        else if (other instanceof ASN1ObjectIdentifier)
